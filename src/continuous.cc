...
public:
  ...
  virtual const char *Name() const {
      ...
      else return SIMLIB_create_name("_Add{%p}", this);
  }
};
...
public:
  ...
  virtual const char *Name() const {
      if(HasName()) return _name;
      else return SIMLIB_create_name("_Sub{%p}", this);
  }
};
...
public:
  ...
  virtual const char *Name() const {
      if(HasName()) return _name;
      else return SIMLIB_create_name("_Mul{%p}", this);
  }
};
...
public:
  ...
  virtual const char *Name() const {
      if(HasName()) return _name;
      else return SIMLIB_create_name("_Div{%p}", this);
  }
};
...
public:
  ...
  virtual const char *Name() const {
      if(HasName()) return _name;
      else return SIMLIB_create_name("_UMinus{%p}", this);
  }
};
