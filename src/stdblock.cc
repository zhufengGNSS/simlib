...
const char *Lim::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Lim{%p}", this);
}
...
const char *Insv::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Insv{%p}", this);
}
...
const char *Qntzr::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Qntzr{%p}", this);
}
...
const char *Frict::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Frict{%p}", this);
}
...
const char *Hyst::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Hyst{%p}", this);
}
...
const char *Relay::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Relay{%p}", this);
}
...
const char *Blash::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Blash{%p}", this);
}
...
const char *Rline::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Rline{%p}", this);
}
