...
#ifndef __SIMLIB__
#   error "simlib2D.h: 19: you must include simlib.h first"
#endif
#if __SIMLIB__ < 0x0212 
#   error "simlib2D.h: 22: requires SIMLIB version 2.12 and higher"
#endif
...
////////////////////////////////////////////////////////////////////////////
// aContiBlock2D --- abstract 2D block with single output
//
...
////////////////////////////////////////////////////////////////////////////
// class Input2D --- continuous block connection (transparent reference)
//
...
////////////////////////////////////////////////////////////////////////////
// Adaptor2D --- 3 scalar inputs, one 2D vector output
//
...
////////////////////////////////////////////////////////////////////////////
// Integrator2D --- vector integrator
//
...
// functions:
Input Abs(Input2D x);               	    // absolute value of vector x
Input2D UnitVector(Input2D x);      	    // unit vector (abs(output)==1)
Input ScalarProduct(Input2D x, Input2D y);  // dot product (x.y)

Input Xpart(Input2D a); // get x part of vector block
Input Ypart(Input2D a); // get y part of vector block
