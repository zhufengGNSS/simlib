...
const char *Integrator::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Integrator{%p}", this);
}
...
/// list of integrators
dlist<Integrator*>* IntegratorContainer::ListPtr=NULL; 
...
const char *Status::Name() const
{
    if (HasName())
        ...
        return SIMLIB_create_name("Status{%p}", this);
}
...
dlist<Status*>* StatusContainer::ListPtr=NULL;
